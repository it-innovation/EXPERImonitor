EXPERImonitor v${project.version} binary release
------------------------------------------------------
...
Binaries
========
The EXPERImonitor service as a WAR file and the libraries required for client development can be found in the 'bin' folder.
