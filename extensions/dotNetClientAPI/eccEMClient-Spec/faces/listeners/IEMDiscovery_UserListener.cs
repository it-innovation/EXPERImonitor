...
public interface IEMDiscovery_UserListener
{
   ...
   */
    void onCreateInterface(Guid senderID, EMInterfaceType type);
   ...
   */
  void onRegistrationConfirmed( Guid     senderID, 
                                bool     confirmed,
                                Guid     expUniqueID,
                                String   expNamedID,
                                String   expName,
   ...
   */
  void onDeregisteringThisClient( Guid senderID,
                                  String reason );
   ...
   * @param senderID - ID of the EM sending this event
   */
  void onRequestActivityPhases(Guid senderID);
   ...
   * @param senderID - ID of the EM sending this event
   */
  void onDiscoverMetricGenerators(Guid senderID);
   ...
   * @param senderID - ID of the EM sending this event
   */
  void onRequestMetricGeneratorInfo(Guid senderID);
   ...
   * @param senderID - ID of the EM sending this event
   */
  void onDiscoveryTimeOut(Guid senderID);
   ...
   * @param senderID - ID of the EM sending this event
   */
  void onSetStatusMonitorEndpoint( Guid senderID,
                                   string endPoint );
}
