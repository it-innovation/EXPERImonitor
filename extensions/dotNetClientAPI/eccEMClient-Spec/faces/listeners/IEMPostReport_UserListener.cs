...
public interface IEMPostReport_UserListener
{
     ...
     */
    void onRequestPostReportSummary(Guid senderID);
     ...
     */
    void onRequestDataBatch(Guid senderID, EMDataBatch reqBatch);
     ...
     */
    void notifyReportBatchTimeOut(Guid senderID, Guid batchID);
}
