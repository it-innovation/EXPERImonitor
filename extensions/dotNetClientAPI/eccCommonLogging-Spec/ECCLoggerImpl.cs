 ...
 * 
 */
public abstract class ECCLoggerImpl : IECCLogger
{
    /**
     ...
     */
    public abstract void debug( Object msg, Exception e );
     ...
     * @param t   - Thrown object for this message.
     */
    public abstract void fatal( Object msg, Exception e );
     ...
     */
    public abstract ECCLoggerImpl createLogger( Type t );
}
