...
public:
    ...
    /**
      ...
      */
    virtual void onStartPushing( const UUID& senderID ) =0;
    ...
    /**
      ...
      */
    virtual void onReceivedPush( const UUID& senderID, const UUID& lastReportID ) =0;
    ...
    /**
      ...
      * @param senderID - ID of the EM
      */
    virtual void onStopPushing( const UUID& senderID ) =0;
    ...
    /**
      ...
      */
    virtual void onPullMetric( const UUID& senderID, const UUID& measurementSetID ) =0;
    ...
    /**
      ...
      */
    virtual void onPullMetricTimeOut( const UUID& senderID, const UUID& measurementSetID ) =0;
    ...
    /**
      ...
      * @param senderID 
      */
    virtual void onPullingStopped( const UUID& senderID ) =0;
    ...
    /**
      ...
      */
    virtual void onReceivedPull( const UUID& senderID, const UUID& lastReportID ) =0;
};
