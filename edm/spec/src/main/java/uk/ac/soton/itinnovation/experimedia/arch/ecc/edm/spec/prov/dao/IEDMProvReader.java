...
public interface IEDMProvReader {
	 ...
	 */
    EDMProvBaseElement getElementCore(String IRI);
	 ...
	 * @return the element's representation in the EDMProv data model
	 */
	EDMProvBaseElement getElement(String IRI);
	 ...
	 */
    EDMProvBaseElement getElement(String IRI, Date start, Date end);
	 ...
	 */
    EDMProvDataContainer getElements(Date start, Date end);
	 ...
	 */
    EDMProvDataContainer getElements(EDMProvBaseElement.PROV_TYPE type, Date start, Date end);
	 ...
	 * @return
	 */
    Set<EDMTriple> getTriples(String subjectIRI, String predicate, String objectIRI);
