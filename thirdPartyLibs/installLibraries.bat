...
call mvn install:install-file -Dfile=.\OWLimProvStore-0.9-SNAPSHOT.jar -DgroupId=uk.ac.soton.itinnovation.edmprov -DartifactId=OWLimProvStore -Dversion=0.9-SNAPSHOT -Dpackaging=jar
