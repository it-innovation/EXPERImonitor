...
2. This Java console application depends on the following libraries:
	 ...
	 experimedia-arch-ecc-edm-factory-2.1.jar
	 experimedia-arch-ecc-edm-spec-2.1.jar
	 experimedia-arch-ecc-edm-impl-metrics-2.1.jar
	 experimedia-arch-ecc-samples-shared-2.1.jar

	* ... Copy these into the same folder containing 'experimedia-arch-ecc-samples-databaseExport-2.1.jar'
