...
public interface EMIAdapterListener
{
     ...
     * 
     */
    void onDescribeSupportedPhases( HashSet<EMPhase> phasesOUT );
     ...
     */
    void onDescribePushPullBehaviours( bool[] pushPullOUT );
     ...
     */
    void onSetupMetricGenerator(Guid metricGeneratorID, bool[] resultOUT);
     ...
     */
    void onPullMetric(Guid measurementSetID, Report reportOUT);
     ...
     */
    void onGetTearDownResult( bool[] resultOUT );
