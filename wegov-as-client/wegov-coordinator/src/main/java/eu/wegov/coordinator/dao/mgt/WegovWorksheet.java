 ...
 */
public class WegovWorksheet extends Dao {
    public static final String TABLE_NAME = "Worksheets";
    
    public WegovWorksheet() {
        this("", "", "", new Timestamp(System.currentTimeMillis()));
    }

    public WegovWorksheet(String name, String comment, String status, Timestamp whenCreated) {
        super(TABLE_NAME);
