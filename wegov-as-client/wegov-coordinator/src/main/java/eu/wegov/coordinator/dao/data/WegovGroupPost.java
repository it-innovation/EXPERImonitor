 ...
 */
public class WegovGroupPost extends Dao {
    public static final String TABLE_NAME = "GroupPosts";
    
    public WegovGroupPost() {
        this("", "", 0);
    }

    public WegovGroupPost(String groupID, String postID, int outputOfRunID) {
        super(TABLE_NAME);
