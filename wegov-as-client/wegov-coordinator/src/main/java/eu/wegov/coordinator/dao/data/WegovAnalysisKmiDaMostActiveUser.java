 ...
 */
public class WegovAnalysisKmiDaMostActiveUser  extends Dao {
    public static final String TABLE_NAME = "AnalysisKmiDaMostActiveUser";
    
    public WegovAnalysisKmiDaMostActiveUser() {
        this(0, "", "", 0, "", "", "", "", 0);
    }

    public WegovAnalysisKmiDaMostActiveUser(int analysisUserID, String screenName, String fullName, int numberOfPosts,
        ...
        properties.add(new Triplet("NumberOfPosts", "integer", numberOfPosts));
    ...
    public Dao createNew() {
        return new WegovAnalysisKmiDaMostActiveUser();
    }
    ...
    public int getNumberOfPosts() {
        return getValueForKeyAsInt("NumberOfPosts");
    }    
