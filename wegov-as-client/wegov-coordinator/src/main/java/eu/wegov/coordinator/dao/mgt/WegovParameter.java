 ...
 */
public class WegovParameter extends Dao {
    public static final String TABLE_NAME = "Parameters";
    
    public WegovParameter() {
        this("", "", "");
    }

    public WegovParameter(String name, String value, String description) {
        super(TABLE_NAME);
        ...
        properties.add(new Triplet("Value", "text", value));
    }

    @Override
    public Dao createNew() {
        return new WegovParameter();
    }
    ...
    public String getValue() {
        return getValueForKeyAsString("Value");
    }
