 ...
 */
public class WegovFriend extends Dao {
    ...
    public WegovFriend(String userID, String friendID, Timestamp startDate, Timestamp endDate, int outputOfRunID) {
        super(TABLE_NAME);
        ...
        properties.add(new Triplet("Friend_SnsUserAccount_ID", "character varying(60) NOT NULL", friendID));
    ...
    public String getFriend_SnsUserAccount_ID() {
        return getValueForKeyAsString("Friend_SnsUserAccount_ID");
    }    
