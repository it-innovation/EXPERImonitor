 ...
 */
public class WegovMentionedUser extends Dao {
    public static final String TABLE_NAME = "MentionedUsers";
    
    public WegovMentionedUser() {
        this("", "", 0);
    }

    public WegovMentionedUser(String postID, String mentionedUserID, int outputOfRunID) {
        super(TABLE_NAME);
        ...
        properties.add(new Triplet("User_SnsUserAccount_ID", "character varying(60) NOT NULL", mentionedUserID));
        properties.add(new Triplet("OutputOfRunID", "integer", outputOfRunID));
    }

    @Override
    public Dao createNew() {
        return new WegovMentionedUser();
    }
