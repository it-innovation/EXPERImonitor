 ...
 */
public class WegovPolicymaker_PolicymakerRole extends Dao {
    public static final String TABLE_NAME = "Policymakers_PolicymakerRoles";
    
    public WegovPolicymaker_PolicymakerRole() {
        this(1, 1);
    }

    public WegovPolicymaker_PolicymakerRole(int policymakerID, int roleID) {
        super(TABLE_NAME);
    ...
    public Dao createNew() {
        return new WegovPolicymaker_PolicymakerRole();
    }
