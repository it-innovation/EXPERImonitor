 ...
 */
public class WegovAnalysisKoblenzMessage extends Dao {
    public static final String TABLE_NAME = "AnalysisKoblenzMessage";
    
    public WegovAnalysisKoblenzMessage() {
        this(0, 0, "", "", "", "", "", "", 0, 0);
    }

    public WegovAnalysisKoblenzMessage(int messageID, int documentID, String originalPostID, String contents, String originalPostURL, String userID, String hostSnsID, String score, int topicID, int outputOfRunID) {
        super(TABLE_NAME);
    ...
    public Dao createNew() {
        return new WegovAnalysisKoblenzMessage();
    }
