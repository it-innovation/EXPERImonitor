 ...
 */
public class WegovGroupMember extends Dao {
    public static final String TABLE_NAME = "GroupMembers";
    
    public WegovGroupMember() {
        this("", "", new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), 0);
    }

    public WegovGroupMember(String groupID, String memberUserID, Timestamp startDate, Timestamp endDate, int outputOfRunID) {
        super(TABLE_NAME);
        ...
        properties.add(new Triplet("User_SnsUserAccount_ID", "character varying(60) NOT NULL", memberUserID));
