 ...
 */
public class WegovPolicymaker_Workflow extends Dao {
    public static final String TABLE_NAME = "Policymakers_Workflows";
    
    public WegovPolicymaker_Workflow() {
        this(1, 1);
    }

    public WegovPolicymaker_Workflow(int policymakerID, int workflowID) {
        super(TABLE_NAME);
    ...
    public Dao createNew() {
        return new WegovPolicymaker_Workflow();
    }
