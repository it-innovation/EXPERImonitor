...
public abstract class SingleSiteSearch implements WegovSearch {
    ...
    /*
     * No longer used private UsernamePasswordCredentials
     * getUsernamePasswordCredentials() throws Exception { String usernameProp =
     * "credentials." + site + ".username"; String passwordProp = "credentials."
     * + site + ".password";
     *
     * String username = getValueOfParameter(usernameProp); String password =
     * getValueOfParameter(passwordProp);
     *
     * if (username == null) throw new Exception("Missing search property: " +
     * usernameProp);
     *
     * if (password == null) throw new Exception("Missing search property: " +
     * passwordProp);
     *
