...
public class WegovAnalysisTool extends WegovTool {
    ...
    private void setupAnalysis() throws Exception {
        ...
        if ((this.analysisType == null) || (this.analysisType.equals(""))) {
            throw new Exception("No analysis type defined");
        }

        this.analysisSubType = getValueOfParameter("analysis.subType");
        if ((this.analysisSubType == null) || (this.analysisSubType.equals(""))) {
            throw new Exception("No analysis sub type defined");
        }
    ...
    /*
     * public TopicOpinionAnalysisResult getTopicAnalysisOutputFromDb (String
     * runId) {
     *
     * WidgetDataAsJson resultWidgetData =
     * loginService.getResultsDataForRun(runId);
     *
     * JSONObject tempDataAsJSONObject =
     * (JSONObject)JSONSerializer.toJSON(resultWidgetData.getDataAsJson());
     *
     * String
     *
     *
