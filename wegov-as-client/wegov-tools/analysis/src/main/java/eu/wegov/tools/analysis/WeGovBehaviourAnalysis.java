...
public class WeGovBehaviourAnalysis extends WeGovAnalysis {
    ...
    public void execute() throws Exception {
        ...
        if (this.subType.equals("twitter-behaviour")) {
            /*
             * JSONObject inputDataAsJSON = (JSONObject)
             * JSONSerializer.toJSON(this.inputDataAsJsonString);
             * inputDataAsJSON = inputDataAsJSON.getJSONObject("postData");
             * String searchQuery =
             * inputDataAsJSON.getString("query").toLowerCase().trim();
...
//		Run analysisRun = loginService.createNewAnalysisRun(analysisActivity, "Role: " + selectedRoleName);
        ...
        try {
            ...
            for (int i = 0; i < numUsers; i++) {
                ...
                profileImageUrl = twitterUserAsJSON.getString("profile_image_url_https");
                ...
                userAccountAgeInDays = ((new Date()).getTime() - createdAtAsDate.getTime()) / (86400000.0);
...
//			System.out.println("Discussion activity");
            ...
            for (int i = 0; i < numPostInInput; i++) {
                ...
                userProfileImageUrl = twitterPostAsJSON.getString("profile_image_url_https");
                twitterPostCreatedAt = twitterPostAsJSON.getString("created_at");
                ...
                createdAtAsDate = dateFormatForPosts.parse(twitterPostCreatedAt);

                postForAnalysis.setDateCreated(new Timestamp(createdAtAsDate.getTime()));
