...
public class WeGovTopicAnalysis extends WeGovAnalysis {
    ...
    public WeGovTopicAnalysis(
            ...
            String analysisLanguage) throws Exception {
    ...
    public void execute() throws Exception {
        ...
        /*
         * public int saveRunResultsDataAsJson( int wsId, int runId, String
         * type, String name, String location, int nResults, String minId,
         * String maxId, Timestamp minTs, Timestamp maxTs, String dataAsJson,
    ...
    public static TopicOpinionAnalysisResult doTopics(
        ...
        try {
            ...
            if (sns.equals("twitter")) {
                ...
                HashMap<String, JSONTwitterUserDetails> userIds_jsonTwitterUserDetails = new HashMap<String, JSONTwitterUserDetails>();
                HashMap<String, JSONTwitterPostDetails> postIds_jsonTwitterPostDetails = new HashMap<String, JSONTwitterPostDetails>();
                ...
                for (int i = 0; i < posts.size(); i++) {
                    ...
                    if (postContentsWithoutHttp.equals("")) {
                        ...
                        userIds_jsonTwitterUserDetails.put(
                                userId,
                                userDetails /*
                                 * new JSONTwitterUserDetails(userId, userName,
                                 * userName, "https://graph.facebook.com/" +
                                 * userId + "/picture"
                    )
                                 */);
                ...
                /*
                 * result = WeGovTopicAnalysis.doTopicsCore( input,
                 * postIds_jsonTwitterPostDetails,
                 * userIds_jsonTwitterUserDetails);
                 */
                result = doTopicsCore(
    ...
    public static TopicOpinionAnalysisResult doTopicsCore(
        ...
        try {
            ...
            for (int topicID = 0; topicID < numTopics; topicID++) {
                ...
                /*
                 * int numPosts = topicDocs.size(); String numPostsStr =
                 * String.valueOf(numPosts);
                 */
            ...
            /*
             * for (int i=0; i < allDocuments.size(); i++) { String
             * documentDetails = ""; int id = d.getID(); documentDetails += id +
             * ":"; double[] sc = d.getTopicScores(); for (int i=0;
             * i<sc.length;i++) { documentDetails += " " +
             * formatter.format(sc[i]); } documentDetails += ": " +
             * output.getDocumentBody(id); System.out.println(documentDetails);
             *
             *
             * }
             */
            /*
             * for (TopicOpinionDocument d : documents) { String documentDetails
             * = ""; int id = d.getID(); documentDetails += id + ":"; double[]
             * sc = d.getTopicScores(); for (int i=0; i<sc.length;i++) {
