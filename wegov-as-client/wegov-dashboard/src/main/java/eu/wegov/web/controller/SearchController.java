...
public class SearchController {
	...
	public @ResponseBody NewActivityAndRun recordNewSearch(@RequestBody final String paramsString) {
		int activityId = 0;
		int runId = 0;
		String error = null;
	...
	public @ResponseBody int updateSearch(@RequestBody final String inputData) {
		try{
