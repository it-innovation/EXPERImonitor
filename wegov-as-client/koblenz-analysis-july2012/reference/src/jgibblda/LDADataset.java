...
public class LDADataset {
	 ...
	 */
	public static LDADataset readDataSet(WegovImporter parent){
		
                
                
                try {
                        LDADataset data = YNFDataReader.read(null, parent);
                        /*
	 ...
	 * @return dataset if success and null otherwise
	 */
	public static LDADataset readDataSet(String filename, Dictionary dict, WegovImporter parent){
		try {
                        LDADataset data = YNFDataReader.read(dict, parent);
                        //data.globalDict = dict;
                        //data.lid2gid = new HashMap<Integer, Integer>();
			//BufferedReader reader = new BufferedReader(new InputStreamReader(
			//		new FileInputStream(filename), "UTF-8"));
