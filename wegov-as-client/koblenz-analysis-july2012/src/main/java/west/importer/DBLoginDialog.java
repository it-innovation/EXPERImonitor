...
public class DBLoginDialog extends JDialog implements ActionListener
{
  ...
  {
    super( new JFrame(), "DB Connection", true );
    setSize( 290, 250 );
  ...
  private JPanel createFieldPanel()
  {
    ...
    hostField = new JTextField( "estrella.uni-koblenz.de", 30 );
    ...
    sidField = new JTextField( "fourcats", 30 );
