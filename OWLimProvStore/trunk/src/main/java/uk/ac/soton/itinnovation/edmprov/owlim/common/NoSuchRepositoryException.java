...
/**
 * An exception class to indicate that a repository does not exists, which is used
 * in the deleteRepository method, for example
...
public class NoSuchRepositoryException extends Exception
{
    ...
    public NoSuchRepositoryException(String msg, Exception ex) {
        super(msg, ex);
    }
}
